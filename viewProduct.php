		...
		<section class="row-fluid">
			<section id="donation_box">
				<section class="container container-fluid">
					<section class="row-fluid">
					<div class="span8 first"> <h2> Products</h2> </div>
		...
		<section class="row-fluid">
			...
			<section class="span9 product_view" id="product_grid">  
					...
					<figure class="span12 first" id="category_title">
							<div class="span10 first"> <h3> Featured Products </h3>	</div>
							<div class="span2"> 
								<ul id="view_switcher"> 
					...
					<?php
						...
						<div class="first product_description">
							<h5><font color="#993300"> <?php echo $row["productTitle"]; ?></font> </h5>
...
-->
			...
			<section id="sidebar" class="span3">
							...
							<figure class="widget slider_products">
								...
								<h3> <i class="icon-pushpin"></i> Product Categries </h3>
