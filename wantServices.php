...
$sql1 = "SELECT * FROM needyservices WHERE userDetailsID = ".$_SESSION['userDeatailsID'].";";
		...
		<section class="row-fluid">
			<!-- BreadCrumbs -->
				<figure id="breadcrumbs" class="span12">
					...
					<li class="active">Need Service</li>
					</ul>
				</figure>
			<!-- End of breadcrumbs -->
		</section>
...
<section id="content" class="mbtm product_grid">
	...
	<div class="contact-form" align="">
		...
		<form action="processWantServices.php" method="post">
					<figure>
					<label>Select Services:</label>
					<span style="width:300px"><select name="cmbWServicesReq" id="product_size">
					<option value=""> Select Services</option>
							...
							<?php
							$servicesvalue = $value['serviceID'];}
							?>
				
							</select>
						</span>
						<label>Date</label>
						<span style="width:300px"><input type="date" name="MyDate1" class="datepicker"/></span>
						<label>Service Description:</label>
						<span style="width:300px"><textarea name="txtWSDESC" /></textarea></span>
						<div>
		...
		<section class="row-fluid">
			<section class="span9 product_view" id="product_grid">  
				...
				<table>
    				<thead>
    					<tr>
            				...
            				<th scope="col" style="font-family:Geneva, Arial, Helvetica, sans-serif; font-size:16px; color:#333333;"><b>Services</b></th>
							...
							<th scope="col" style="font-family:Geneva, Arial, Helvetica, sans-serif; font-size:16px; color:#333333;"><b>Description</b></th>
						</tr>
					</thead>
					<tbody>
				 <?php
			    ...
			    {?>     
							...
							<td style="font-family:Geneva, Arial, Helvetica, sans-serif; font-size:14px; color:#999999;" ><?php echo $rowService['serviceTitle'];?></td>
							...
							<td style="font-family:Geneva, Arial, Helvetica, sans-serif; font-size:14px; color:#999999;">&nbsp;</td>
							<td style="font-family:Geneva, Arial, Helvetica, sans-serif; font-size:14px; color:#999999;"><?php echo $row['needyServiceDescription'];?></td>
