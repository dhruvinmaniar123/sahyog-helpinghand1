...
$_SESSION['userDeatailsID'] = $rec['userDetailsID'];
	$sql1 = "SELECT * FROM userproduct WHERE userDetailsID = ".$_SESSION['userDeatailsID'].";";
		...
		<section class="row-fluid">
			<!-- BreadCrumbs -->
				<figure id="breadcrumbs" class="span12">
					...
					<li class="active">Donate Product</li>
					</ul>
				</figure>
			<!-- End of breadcrumbs -->
		</section>
...
<section id="content" class="mbtm product_grid">
	...
	<div class="contact-form" align="">
		...
		<form action="processGiveProduct.php" method="post">
					<figure>
					<label><font color="#FF0000">*</font>&nbsp;Category:</label>
										...
										<labe><font color="#FF0000">*</font>&nbsp;Product:</label>
		...
		<section class="row-fluid">
			<section class="span9 product_view" id="product_grid">  
			    ...
			    {?>     
							...
							<td style="font-family:Geneva, Arial, Helvetica, sans-serif; font-size:14px; color:#999999;">&nbsp;</td>
							<td style="font-family:Geneva, Arial, Helvetica, sans-serif; font-size:14px; color:#999999;"><?php echo $row['userProductDescription'];?></td>
								<td style="font-family:Geneva, Arial, Helvetica, sans-serif; font-size:14px; color:#999999;">&nbsp;</td>
							<td style="font-family:Geneva, Arial, Helvetica, sans-serif; font-size:14px; color:#999999;" align="center">
							<a href="processGiveProduct.php?action=delete&&id=<?php echo $row['userProductID'];?>" >
